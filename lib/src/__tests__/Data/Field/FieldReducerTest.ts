...
describe('FieldReducerTest', () => {
    ...
    it('should handle change value action', () => {
    ...
    it('should handle change validation state action', () => {
    ...
    it('should handle change property action for non typed property', () => {
        ...
        const expectedState: State = {
            ...
            fields: {
                ...initialState.fields,
                test: {...initialState.fields.test, nonTypedProperty: 'test-value'},
            },
        };
        expect(newState).toEqual(expectedState);
    });

    it('should return state when submitting action for non defined field', () => {
